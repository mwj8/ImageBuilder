...
PACKAGES="$PACKAGES blockd kmod-scsi-generic ntfs-3g kmod-ata-core kmod-ata-ahci kmod-block2mtd kmod-scsi-generic kmod-fs-nfs kmod-fs-nfs-common kmod-nls-cp936 kmod-usb-ohci kmod-usb2 kmod-usb3 gzip unzip blkid lsblk hdparm"
